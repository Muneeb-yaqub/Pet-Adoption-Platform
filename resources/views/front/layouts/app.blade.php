...
<head>
	...
	<title>Pet Adoption Platform | Find Your Perfect Pet</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<li class="nav-item">
						<a class="nav-link" aria-current="page" href="">Find Pets</a>
					</li>										
				</ul>
				...
				@endif
				<a class="btn btn-primary" href="" type="submit">Post a Pet</a>
